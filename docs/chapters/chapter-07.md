# فصل ۷: پیاده‌سازی احراز هویت و امن‌سازی اپلیکیشن
...
اپلیکیشن‌های web با تهدیدات امنیتی زیادی روبه‌رو هستند، اما دو مورد از رایج‌ترین‌ها حملات XSS و security headerهای缺失 هستند. حملات XSS scriptهای مخرب را در اپلیکیشن ما تزریق می‌کنند در حالی که security headerهای缺失 اپلیکیشن را در برابر حملات مختلف مبتنی بر مرورگر آسیب‌پذیر می‌کند. بیایید ببینیم چگونه در برابر این تهدیدات محافظت کنیم.
